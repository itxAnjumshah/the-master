      ...
      <div className="relative w-full max-w-3xl min-h-[550px] bg-yellow-400 mx-auto shadow-2xl overflow-hidden border-6 border-yellow-500 rounded-lg transform hover:scale-105 transition-transform duration-500 ease-in-out px-4 sm:px-8 py-4 sm:py-8">
        ...
        <div className="relative z-10 text-center h-full">
          ...
          <div className="flex justify-between text-xs sm:text-sm mb-4 font-semibold">
            <div className="bg-gray-200 px-2 py-1 rounded-full text-black">Roll No: <span className="text-black">12345</span></div>
            <div className="bg-gray-200 px-2 py-1 rounded-full text-black">Registration No: <span className="text-black">76568</span></div>
          </div>
          ...
          <div className="flex flex-col items-center my-6">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-black mt-3 font-serif border-b-2 border-black px-4 pb-1">Muhammad Ikhlaq</h3>
            <p className="text-black mt-1 text-xs sm:text-md">S/o <span className="font-medium border-b border-black px-1">Anjum</span></p>
            <div className="mt-3 px-4 py-1 bg-blue-200 rounded-full border border-blue-300 shadow-sm">
              <p className="text-sm sm:text-md font-bold text-blue-800">Mobile Crane Operator</p>
            </div>
          </div>

          {/* Certification Statement */}
          <p className="text-xs sm:text-md leading-relaxed text-black font-bold mb-8 px-4 sm:px-8">
            has successfully completed the <span className="font-semibold text-green-700">Mobile Crane Operator</span> training program<br />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 px-4 sm:px-8">
            <div className="text-center bg-amber-100 py-3 rounded-lg border border-amber-200 shadow-md">
              ...
              <div className="text-lg sm:text-xl font-bold text-amber-700">75%</div>
            </div>
            <div className="text-center bg-blue-100 py-3 rounded-lg border border-blue-200 shadow-md">
              ...
              <div className="text-lg sm:text-xl font-bold text-blue-700">GOOD</div>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <div className="font-medium text-black">07 January 2019</div>
          </div>
